...
import com.formation.springproducts.repository.IProductRepository;
 ...
 *
 * @Service : Annotation Spring qui marque cette classe comme un service
 * Spring la détectera automatiquement et gérera son injection
 */
@Service
public class ProductService {
     ...
     * Spring injecte automatiquement IProductRepository (pas besoin d'@Autowired depuis Spring 4.3)
     * @param productRepository le repository à injecter
     */
